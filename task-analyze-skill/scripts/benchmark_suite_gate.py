...
ARMS = ("direct", "global")
DIRECT_BASELINE_PAIR = "gpt-6-sol|ultra"
AUTO_ENTRY_PAIR = "gpt-6-luna|max"
...
OVERALL_RULE = "all task results pass the independent post-result audit AND every tier lowers steady-state execution and logical tokens AND aggregate steady-state execution and logical tokens are lower"
...
# Historical benchmark manifests call this audit "ending_real"; it is not the projectless memory Ending task.
