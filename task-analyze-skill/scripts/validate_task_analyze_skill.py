...
REQUIRED_SKILL_TEXT = [
    ...
    "Every new user task gets a post-result independent Ending",
    ...
    "End Task is mandatory for every new user task",
...
REQUIRED_PYTHON_REFERENCE_TEXT = ["## Quick Check And Detached Ending", "Before presenting a light/local Python edit", "build real proportional Ending checks", "exactly one persistent projectless Ending", "Multiple unit, integration/API, and runtime checks stay inside that one Ending", "Every required check must PASS", "effective project-result memory", "memory-only defect", "Skill or execution defects", "codex_app__send_message_to_thread", "immutable origin session", "fresh Ending", "--repair-of-lifecycle-id"]
