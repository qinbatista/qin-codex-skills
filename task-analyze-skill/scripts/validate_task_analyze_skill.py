...
REQUIRED_UNITY_REFERENCE_TEXT = ["uses this file plus", "Return the final updated C# code first", "constructor calls and object-creation expressions on one physical line", "each `new Type(...)` entry flat", "vertically stacked arguments", "new InAppPurchaseProduct(ProductId.Coin500.ToString()"]
