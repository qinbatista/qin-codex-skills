...
class ValidateTaskAnalyzeSkillTests(unittest.TestCase):
    ...
    def test_inline_bootstrap_requires_material_ending_handoff_and_no_pre_result_verify(self):
        ...
        try:
            ...
            self.assertIn("project/current-task/same-task-subtask placement", bootstrap_text)
            ...
            self.assertNotIn("exact saved project", bootstrap_text)
            self.assertIn("resolve root with codex_app__list_projects", bootstrap_text)
