...
class ValidateWorkflowSkillTests(unittest.TestCase):
    ...
    def test_global_entry_required_terms_match_compact_contract(self):
        ...
        self.assertIn("Every result,including read-only,triggers a visible End Task", required)
        self.assertIn("exact saved project", required)
        self.assertIn("End/Fix stay visible", required)
