...
class ValidateWorkflowSkillTests(unittest.TestCase):
    ...
    def test_global_entry_required_terms_match_compact_contract(self):
        ...
        self.assertIn("Only the final aggregate `ending-required` or `ending_required=true` receipt after all result nodes settle=>one independent global projectless Ending when real_test/information_update/memory_update exists", required)
        ...
        self.assertIn("fresh global projectless End Task", required)
