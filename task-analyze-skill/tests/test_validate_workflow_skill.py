...
class ValidateWorkflowSkillTests(unittest.TestCase):
    ...
    def test_global_entry_required_terms_match_compact_contract(self):
        ...
        self.assertIn("executes Spark-low first", required)
        ...
        self.assertIn("call exact codex_app__create_thread target", required)
    ...
    def test_executor_skills_support_inline_and_admitted_modes(self):
        ...
        self.assertIn("A low-risk, low-ambiguity code, write, probe, command, transform, or execute segment scoring `0-24` tries the catalog priority producer first", code_text)
