"""Offline visibility and result release regressions; no live model/task claims."""
...
class RoutingVisibilityTests(unittest.TestCase):
        ...
        return {"schema_version": 2, "entry": {"model": "gpt-6-astra", "effort": "ultra"},
                ...
                "nodes": [{"id": "collect", "phase": "result", "model": "gpt-6-luna", "effort": "low",
                          ...
                          {"id": "result", "phase": "result", "skill": "code-skill", "purpose": "Apply the code preference",
                           "model": "gpt-6-luna", "effort": "low", "prompt": "Update the scoped function.", "dependencies": ["collect"]}]}
    ...
    def test_disclosure_and_projectless_memory_launch_wait_for_aggregate_release(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(actual[0]["actual_pair"], "gpt-6-luna|low")
            ...
            self.assertIn("Assignment: gpt-6-astra|ultra -> gpt-6-luna|low", compact["model_disclosure"]["message"])
            self.assertTrue(manifest["final_aggregate_receipt"])
