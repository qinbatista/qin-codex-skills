...
- Always give the user a concise completion report after implementation, revert, verification, or file-edit work. Include the scope, changed files or generated artifacts, verification commands/evidence, pass/fail result, and remaining state such as unpushed commits, unstaged changes, blockers, or known expected warnings.
