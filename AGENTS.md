...
- Preserve every retained capability, add focused regression coverage for durable behavior changes, require post-install source/deployed/platform/parity PASS before calling a local installation complete, and require the full release gate before publication.
