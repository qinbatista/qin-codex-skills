...
Preserve durable outputs. Release disposable resources in reverse acquisition order after their last consumer and output readback. Keep shared, pre-existing, conflicted, Unity, or remote resources unless explicitly authorized for removal. Delete only task-owned `Cache/temp-*` scratch automatically.
