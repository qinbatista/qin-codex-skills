...
REQUIRED_WORKFLOW = [
    ...
    "projects the same event ID to broad `Model Switch.md`",
...
REQUIRED_MANAGEMENT = ["Do not load this skill for ordinary exact-scoped read-only work or Direct/Global benchmark worker arms", "directly only for an explicit routing-record", "admitted a delegated route", "broad Model Switch.md", "Every task stores a `0-100` score", "Eligible small low-risk edits try Spark first", "Spark quality failure suppresses", "two PASS results trial one rung down", "obsidian_model_memory.py", "Ending Real starts with the producer receipt", "terminal ledger event records the result automatically", "legacy read-only", "Model stages (N):", "end_task_trigger_rate=100%", "Never push/sync/publish unless the user explicitly requested publishing"]
