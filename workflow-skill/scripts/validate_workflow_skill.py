...
def validate(skill_dir):
    ...
    failures.extend(missing_terms("workflow agent", texts["agent"], ["eligible small low-risk edits try Spark", "matching Obsidian context", "saved highest-family quality pair", "One receipt-backed Real PASS keeps it", "two PASS trial down", "quality FAIL upgrades", "operational failure is neutral", "Publish after Quick Check", "Every result launches ending_verification_plan.py", "exact saved project", "project/local task", "all PASS and remain visible", "Never auto-archive/delete", "difficulty/pairs", "attempts", "first/retry", "suitability", "Obsidian link", "no receipt writes a non-learning observation", "same-project repair", "fresh verification", "up to three", "Never expose private reasoning", "self-verify", "same-task subagent"]))
