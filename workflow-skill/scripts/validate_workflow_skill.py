...
REQUIRED_VERIFY = ["Verification has two scopes", "mandatory post-result Ending Real Verify", "Every durable code change", "persistent global projectless", "ending_verification_plan.py", "each check keeps its own `0-100` score", "All required checks must PASS", "{\"type\":\"projectless\"", "codex_app__list_threads", "projectId=null", "--thread-scope global --thread-project-id null", "create-launches", "ack-launch", "end_task_trigger_rate=100%", "Model stages (N):", "remains visible", "Never call `set_thread_archived`", "origin project binding", "structured `model_assessment`", "learning_eligible=false", "fresh global projectless Ending", "gpt-5.3-codex-spark|xhigh", "gpt-5.6-luna|low", "ENDING_CHECK_WORKER", "delegated_check_worker", "BLOCKED does not count as verified"]
