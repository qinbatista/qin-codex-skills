...
6. If no subagent/delegation tool is callable, state `Ending Workflow blocked: no subagent tool` before doing any required minimum closeout in the main agent.
