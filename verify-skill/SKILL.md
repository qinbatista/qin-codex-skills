...
Ending belongs to [Project Memory](../project-memory-skill/SKILL.md) and only updates Obsidian memory with facts established here. It never verifies, repairs, or changes this task's result. Historical Ending plans must not execute old check commands.
